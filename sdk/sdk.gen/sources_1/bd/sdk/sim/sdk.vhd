...
--Date        : Wed Nov 19 22:31:43 2025
--Host        : issam-XPS-9315 running 64-bit Ubuntu 24.04.3 LTS
--Command     : generate_target sdk.bd
--Design      : sdk
...
entity sdk is
  ...
  attribute CORE_GENERATION_INFO of sdk : entity is "sdk,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=sdk,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=1,numReposBlks=1,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=Hierarchical}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of sdk : entity is "sdk.hwdef";
end sdk;

architecture STRUCTURE of sdk is
  component sdk_processing_system7_0_0 is
  port (
  ...
  end component sdk_processing_system7_0_0;
...
begin
processing_system7_0: component sdk_processing_system7_0_0
     port map (
