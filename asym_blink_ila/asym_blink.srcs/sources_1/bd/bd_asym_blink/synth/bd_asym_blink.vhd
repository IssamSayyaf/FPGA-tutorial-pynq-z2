...
entity bd_asym_blink is
  ...
  attribute CORE_GENERATION_INFO of bd_asym_blink : entity is "bd_asym_blink,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_asym_blink,x_ipVersion=1.00.a,x_ipLanguage=VHDL,numBlks=4,numReposBlks=4,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_ps7_cnt=1,synth_mode=OOC_per_IP}";
  attribute HW_HANDOFF : string;
  attribute HW_HANDOFF of bd_asym_blink : entity is "bd_asym_blink.hwdef";
end bd_asym_blink;

architecture STRUCTURE of bd_asym_blink is
  component bd_asym_blink_processing_system7_0_0 is
  port (
  ...
  component bd_asym_blink_ila_0_0 is
  port (
    clk : in STD_LOGIC;
    probe0 : in STD_LOGIC_VECTOR ( 20 downto 0 );
    probe1 : in STD_LOGIC_VECTOR ( 0 to 0 )
  );
  end component bd_asym_blink_ila_0_0;
...
asym_blink_0: component bd_asym_blink_asym_blink_0_0
     port map (
...
ila_0: component bd_asym_blink_ila_0_0
     port map (
      clk => processing_system7_0_FCLK_CLK0,
      probe0(20 downto 0) => c_counter_binary_0_Q(20 downto 0),
      probe1(0) => asym_blink_0_led
    );
processing_system7_0: component bd_asym_blink_processing_system7_0_0
     port map (
