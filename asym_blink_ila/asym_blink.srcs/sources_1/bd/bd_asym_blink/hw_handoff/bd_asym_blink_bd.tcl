...
################################################################
# This is a generated script based on design: bd_asym_blink
#
...
# source bd_asym_blink_script.tcl
...
proc create_root_design { parentCell } {
  ...
  # Create instance: asym_blink_0, and set properties
  set block_name asym_blink
  set block_cell_name asym_blink_0
  if { [catch {set asym_blink_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $asym_blink_0 eq "" } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_CAN_PERIPHERAL_FREQMHZ {23.793104} \
   CONFIG.PCW_ACT_DCI_PERIPHERAL_FREQMHZ {10.096154} \
   CONFIG.PCW_ACT_ENET0_PERIPHERAL_FREQMHZ {25.090908} \
   CONFIG.PCW_ACT_ENET1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {98.571434} \
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {197.142868} \
   CONFIG.PCW_ACT_QSPI_PERIPHERAL_FREQMHZ {197.142868} \
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {49.285717} \
   ...
   CONFIG.PCW_CRYSTAL_PERIPHERAL_FREQMHZ {30} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR0 {52} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR1 {2} \
   CONFIG.PCW_DDRPLL_CTRL_FBDIV {35} \
   ...
   CONFIG.PCW_ENET0_PERIPHERAL_DIVISOR0 {11} \
   ...
   CONFIG.PCW_I2C_PERIPHERAL_FREQMHZ {110.000000} \
   CONFIG.PCW_I2C_RESET_ENABLE {1} \
   CONFIG.PCW_I2C_RESET_SELECT {Share reset pin} \
   CONFIG.PCW_IOPLL_CTRL_FBDIV {46} \
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {1380.000} \
   ...
   CONFIG.PCW_SDIO_PERIPHERAL_DIVISOR0 {28} \
  ...
  connect_bd_net -net asym_blink_0_led [get_bd_ports led] [get_bd_pins asym_blink_0/led] [get_bd_pins ila_0/probe1]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins asym_blink_0/count] [get_bd_pins c_counter_binary_0/Q] [get_bd_pins ila_0/probe0]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins asym_blink_0/clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins ila_0/clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
