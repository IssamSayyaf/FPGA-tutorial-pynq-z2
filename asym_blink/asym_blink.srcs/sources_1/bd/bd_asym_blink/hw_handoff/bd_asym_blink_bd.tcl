...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {250.0} \
  ...
  connect_bd_net -net asym_blink_0_led [get_bd_ports led] [get_bd_pins asym_blink_0/led]
  connect_bd_net -net c_counter_binary_0_Q [get_bd_pins asym_blink_0/count] [get_bd_pins c_counter_binary_0/Q]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins asym_blink_0/clk] [get_bd_pins c_counter_binary_0/CLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
